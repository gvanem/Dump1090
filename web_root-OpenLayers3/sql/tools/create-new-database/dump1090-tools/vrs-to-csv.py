...
def extract(dbfile):
	...
	# AKISSACK - Amended to read from my VRS Database file that doesnt have a Model table
	with closing(db.execute('SELECT ModeS, Registration, ICAOTypeCode FROM Aircraft')) as c:
