...
def check_pygame_modules():
  ...
  pygame.init()
  print (" - Video: %s" % [ "Not available - install libsdl2-2.0-0", "Supported" ][pygame.display.get_init()])
  print (" - Font:  %s" % [ "Not available - install libsdl2-ttf-2.0-0", "Supported" ][pygame.font.get_init()])
  print (" - Image: %s" % [ "Not available - install libsdl2-image-2.0-0", "Supported" ][pygame.image.get_extended()])
